...
const InterviewPrep = () => {
  ...
  const toggleQuestionPinStatus = async(questionId) => {
    try {
      ...
      if(response.data && response.data.question) {
        //toast.suucess('Question Pinned Successfully')
  ...
  const uploadMoreQuestions = async() => {
    try {
      ...
      //Cal AI API to generate questions
                    ...
                    <>
                      ...
                      {!isLoading &&
                          ...
                          <div className='flex items-center justify-center mt-5'>
                            <button
                              className='flex items-center gap-3 text-sm text-white font-medium bg-black px-5 py-2 mr-2 rouned text-nowrap cursor-pointer'
